...
public:
    void drawRotarySlider(juce::Graphics &g, int x, int y, int width, int height, float sliderPos,
        float rotaryStartAngle, float rotaryEndAngle, juce::Slider &slider) override // hangerőszíbályzó megrajzolása
    {
...
class FontLookAndFeel : public juce::LookAndFeel_V4 { // gombok stilizálása
public:
...
private:
   ...
   std::unique_ptr<juce::AudioFormatReaderSource> playSource; // audio forrás
   ...
   int maxBufferSize = 44100 * 60; // max 60mp mono csatornánként
